...
/** 管理员根据ID获取应用详情 GET /app/admin/get/vo */
...
/** 流式生成代码 根据提示词流式生成应用代码（SSE） GET /app/chat/gen/code */
...
/** 部署应用 将应用代码部署并返回访问 URL POST /app/deploy */
...
/** 分页获取我的应用列表 POST /app/my/list/page/vo */
...
/** 更新应用 用户只能更新自己的应用名称 POST /app/update */
